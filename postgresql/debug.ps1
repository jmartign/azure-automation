...
$cloudServiceName =  "postgresqlsabbour"
...
New-AzureVM -ServiceName $cloudServiceName -VMs $vm1Configuration -VNetName $networkName -InternalLoadBalancerConfig $ilbConfig -Verbose
